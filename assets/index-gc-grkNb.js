...
`,ye=({q:e,children:t})=>{const[n,r]=et.useState(!1);return m.jsxs(k2,{open:n,children:[m.jsxs(S2,{open:n,onClick:()=>r(!n),children:[n?m.jsx(x2,{size:96,strokeWidth:1.5,color:"var(--darkgreen)"}):m.jsx(y2,{size:96,strokeWidth:1.5,color:"white"}),m.jsx("p",{children:e})]}),n&&m.jsx(b2,{open:n,children:t})]})},E2=N.div`
  padding-top: 75px;
  max-width: 1000px;
  margin: 0 auto;
`,so=N.div`
...
`,P2=N.h2`
  ...
  letter-spacing: 3px;
  font-family: GentiumBookPlus;
`;function C2(){return m.jsxs(E2,{id:"faq",children:[m.jsx(P2,{children:"Frequently Asked Questions"}),m.jsxs(so,{children:[m.jsx(uo,{children:"GENERAL"}),m.jsxs(ye,{q:"What is WildHacks?",children:["WildHacks is a ",m.jsx("span",{children:"weekend-long event"})," where students work together to create cool software projects! You can expect"," ",m.jsx("span",{children:"workshops"}),","," ",m.jsx("span",{children:"free food from Evanston restaurants"}),","," ",m.jsx("span",{children:"fun social and de-stress events"}),", ",m.jsx("span",{children:"free swag"}),", and more!"]}),m.jsxs(ye,{q:"When is WildHacks?",children:["WildHacks 2024 will take place from ",m.jsx("span",{children:"Friday, April 5, 2024"})," ","to ",m.jsx("span",{children:"Sunday, April 7, 2024"}),". However, hacking won't start until the tracks are released on ",m.jsx("span",{children:"April 6"})," at"," ",m.jsx("span",{children:"11:00 AM"}),", with check in for the event starting at"," ",m.jsx("span",{children:"9:00 AM"})," that same day. Starting at ",m.jsx("span",{children:"5:00 PM"})," ","on ",m.jsx("span",{children:"April 5"}),", we'll have Workshop Night, which is an optional opportunity for you to learn some skills to help you with your hackathon project. You are welcome to skip that part of the event if you wish and check in on Saturday morning."]}),m.jsx(ye,{q:"Where is WildHacks?",children:"WildHacks will take place on the Northwestern University campus. More details will be released closer to the event."}),m.jsxs(ye,{q:"Is this hackathon purely coding-based?",children:["The hackathon will be ",m.jsx("span",{children:"software-focused"}),", but don't worry if you don't have prior coding experience. We'll send out resources and have workshops to help you learn how to code."]}),m.jsxs(ye,{q:"Where can I find an event schedule?",children:["The full schedule will be released closer to the event, but check-in will begin at ",m.jsx("span",{children:"9:00 AM"})," on"," ",m.jsx("span",{children:"Saturday, April 6, 2024"})," with the opening ceremony starting at ",m.jsx("span",{children:"11:00 AM"}),", and the closing ceremony will end at ",m.jsx("span",{children:"5:00 PM"})," on ",m.jsx("span",{children:"Sunday, April 7, 2024"}),". Workshop Night will take place at ",m.jsx("span",{children:"5:00 PM"})," on"," ",m.jsx("span",{children:"Friday, April 5, 2024"}),"."]}),m.jsxs(ye,{q:"What will I submit?",children:["At the end of the hackathon, you'll submit your project's"," ",m.jsx("span",{children:"source code"}),", a ",m.jsx("span",{children:"2-minute video pitch"}),", and any other relevant resources to the WildHacks Dashboard. Top projects will be selected to ",m.jsx("span",{children:"demo live on stage"})," to win prizes. A detailed rubric will be released during the event."]})]}),m.jsxs(so,{children:[m.jsx(uo,{children:"REGISTRATION / TEAMS"}),m.jsxs(ye,{q:"Who is eligible to participate?",children:["All ",m.jsx("span",{children:"university students"})," are eligible to participate in WildHacks! High school students are unfortunately not eligible to participate in WildHacks."]}),m.jsxs(ye,{q:"What if I've never coded before?",children:["WildHacks is open to students of ",m.jsx("span",{children:"all experience levels"}),"! We'll send out resources with beginner-friendly tutorials and workshops, and we'll will have a Discord server on which you can ask questions."]}),m.jsxs(ye,{q:"How will teams work?",children:["Teams can consist of up to ",m.jsx("span",{children:"4 members"}),"! We strongly encourage you to work with others."]}),m.jsxs(ye,{q:"Are you required to have a team to register?",children:[m.jsx("span",{children:"No, you are not required to register with a team."})," At the start of the event, if you don't already have a team in mind, you can choose find a team to join or be randomly assigned to one. There will be time during the event to find team members, but you can also find members on the Discord server."]})]}),m.jsxs(so,{children:[m.jsx(uo,{children:"LOGISTICS"}),m.jsx(ye,{q:"Will there be sleeping / showering accommodations?",children:"There will be a room reserved overnight dedicated to sleeping. However, we recommend bringing pillows and blankets. There are showers at Mudd Library, and we'll provide toiletries (shower gel, shampoo, and conditioner), but we recommend bringing your own towel. However, you're welcome to come to and go from the event as you please."}),m.jsx(ye,{q:"Will transportation be reimbursed?",children:"Unfortunately, transportation will not be reimbursed."}),m.jsxs(ye,{q:"Do I have to come to Workshop Night?",children:[m.jsx("span",{children:"Workshop Night is optional!"})," The actual hacking portion of the hackathon will not start until the morning of April 6. However, if you're interested in learning some skills to help you with your hackathon project, we recommend coming to Workshop Night. We'll provide food!"]}),m.jsx(ye,{q:"Do I have to stay for the full event?",children:"No, you are free to leave the event before the hackathon ends! However, in order to claim prizes, you must be present at the closing ceremony on Sunday, April 7 at 4:00 PM."})]}),m.jsxs(so,{children:[m.jsx(uo,{children:"SUPPORT"}),m.jsxs(ye,{q:"How can I get in touch?",children:["Send us an email at ",m.jsx("span",{children:"wildhacks@northwestern.edu"}),"! We'd be happy to answer any questions about the event or steps to get involved."]}),m.jsxs(ye,{q:"I'm interested in sponsoring WildHacks. Who should I contact?",children:["Send us an email at ",m.jsx("span",{children:"wildhacks@northwestern.edu"}),"! We'd be happy to talk."]})]})]})}const j2=N.div`
  // margin: 72px 16px;
  margin-bottom: 2px;
`,_2=N.h2`
  text-align: left;
